					...
					<div>
						...
						{/*<ul>
							<li>
								<div className={card}>
									<header>
										<img src={'data:image/jpeg;base64,'}
											 alt={'icon CampusID'}
											 style={{ width: '100px', marginRight: '10px', borderRadius: '15px' }} />

										<div>
											<div className="titles-container">
												<h2> Master SDS </h2>
												<span className={badge}> Software Development Specialist </span>
												<span className={badge}> Bac +5 </span>
											</div>
									...
									<header>
										...
										<div>
											<div className="titles-container">
												<h2> Bachelor SDS </h2>
												<span className={badge}> Software Development Specialist </span>
												<span className={badge}> Bac +3 </span>
											</div>
											...
											<span style={{ fontSize: '12px' }}>
												<FaIcon type={FaIconsType.SOLID} icon={'hourglass-start'} /> 2014&nbsp;
							...
							<li>
								<div className={card}>
									<header>
										<img src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTwyua5x9_KcmwUmewXxjsab5vLMVYR9HoTMA&usqp=CAU'}
										     alt={'icon Lycée Jules Ferry - cannes'}
										     style={{ width: '100px', minWidth: '100px', marginRight: '10px', borderRadius: '15px' }} />

										<div>
											<div className="titles-container">
												<h2> Bac STI2D - Option SIN </h2>
												<span className={badge}>
											...
											<span style={{ fontSize: '12px' }}>
												<FaIcon type={FaIconsType.SOLID} icon={'hourglass-start'} /> 2013&nbsp;
												<FaIcon type={FaIconsType.SOLID} icon={'hourglass-end'} /> 2014
											</span>
										</div>
									</header>
								</div>
